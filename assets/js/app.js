(() => {
  ...
  function renderHome(){
    return `<section class="hero reveal"><span class="eyebrow">${D.meta.code} · Full Course Hub</span><h1>Engineering Mechanics, organized for the exam — not just for reading.</h1><p class="lead">A fast, mobile-friendly set-wise study website built from your class notes, lecture slides, regular question banks, backlog paper and the Faires solution reference. Complex ideas include Bangla explanations, formulas, proofs, sketches and exam shortcuts.</p><div class="hero-actions"><a class="primary-btn" href="#/part-a">Start Part A ${icons.arrow}</a><a class="secondary-btn" href="#/analysis">See QB Priority</a><a class="secondary-btn" href="downloads/CE1201_Master_Study_Guide.pdf" download>${icons.download} Full PDF</a></div></section>
    <div class="stats-grid reveal"><div class="stat-card"><div class="stat-number">8</div><div class="stat-label">Core Sets (A1–A4, B1–B4)</div></div><div class="stat-card"><div class="stat-number">40+</div><div class="stat-label">Essential Formula Entries</div></div><div class="stat-card"><div class="stat-number">${D.solutions.length}</div><div class="stat-label">Fully Explained Core Solutions</div></div><div class="stat-card"><div class="stat-number">4</div><div class="stat-label">Downloadable Question PDFs</div></div></div>
  ...
  function renderBacklog(){
    return `${pageTitle('Dedicated Section','Backlog Preparation',D.backlog.warning)}<div class="notice warn reveal"><div>↺</div><div><strong>Backlog 2023 is treated separately.</strong> Regular-exam priority statistics above are not reused as a backlog prediction without checking the backlog paper.</div></div>
  ...
  function renderDownloads(){
    return `${pageTitle('Offline Resources','PDF Downloads','Download the master guide and the supplied question-paper bundles. PDF files are not loaded until you click them, keeping the website fast.')}
