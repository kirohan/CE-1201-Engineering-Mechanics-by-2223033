window.CE1201_DATA = {
  ...
  studyPdfs: {
    partA:{name:'Part A Complete Class Note',href:'downloads/study-pdfs/CE1201_Section_A_Class_Note.pdf',pages:27},
    partB:{name:'Part B Complete Class Note',href:'downloads/study-pdfs/CE1201_Section_B_Class_Note.pdf',pages:22},
    analysis:{name:'Question Bank Analysis',href:'downloads/study-pdfs/CE1201_Question_Bank_Analysis.pdf',pages:17},
    formula:{name:'Formula + Theory + Proof/Derivations',href:'downloads/study-pdfs/CE1201_Formula_Theory_Proof_Derivations.pdf',pages:32},
    solutions:{name:'Complete Question Bank Solution',href:'downloads/study-pdfs/CE1201_Complete_Question_Bank_Solution.pdf',pages:39},
    backlog:{name:'Complete Backlog Preparation Guide',href:'downloads/study-pdfs/CE1201_Backlog_Preparation_Guide.pdf',pages:28}
  },
  sourceLibrary: [
    ...
    {name:'Complete Study PDF Pack (6 PDFs)', href:'downloads/CE1201_Complete_Study_PDF_Pack.zip', type:'Study Pack ZIP'},
    {name:'Part A Complete Class Note', href:'downloads/study-pdfs/CE1201_Section_A_Class_Note.pdf', type:'Generated Study PDF · 27 pages'},
    {name:'Part B Complete Class Note', href:'downloads/study-pdfs/CE1201_Section_B_Class_Note.pdf', type:'Generated Study PDF · 22 pages'},
    {name:'Question Bank Analysis', href:'downloads/study-pdfs/CE1201_Question_Bank_Analysis.pdf', type:'Generated Study PDF · 17 pages'},
    {name:'Formula + Theory + Proof/Derivations', href:'downloads/study-pdfs/CE1201_Formula_Theory_Proof_Derivations.pdf', type:'Generated Study PDF · 32 pages'},
    {name:'Complete Question Bank Solution', href:'downloads/study-pdfs/CE1201_Complete_Question_Bank_Solution.pdf', type:'Generated Study PDF · 39 pages'},
    {name:'Complete Backlog Preparation Guide', href:'downloads/study-pdfs/CE1201_Backlog_Preparation_Guide.pdf', type:'Generated Study PDF · 28 pages'}
  ]
};
